...
if __name__ == "__main__":
    ...
    for fruit, couleur in FRUITS.items():
        deplacer_sans_tracer(randint(-LARGEUR//2.5, LARGEUR//2.5), randint(-HAUTEUR//2.5, HAUTEUR//2.5))
        turtle.pencolor(couleur)
        turtle.write(fruit, align = ALIGNEMENTS[randint(0, len(ALIGNEMENTS)-1)], font = ("Arial", randint(14, 30), FORMATAGES[randint(0, len(FORMATAGES)-1)]))
